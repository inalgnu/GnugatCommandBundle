...
awesome:
 ...
 1. [Fork the repository](https://github.com/gnugat/GnugatCommandBundle/fork_select);
 2. track the upstream (original) repository: `git remote add upstream https://github.com/gnugat/GnugatCommandBundle.git`;
